...
export const metadata = {
  title: 'Gpu Shortage Explained | GPU Drip',
  description: 'Comprehensive guide and analysis for Gpu Shortage Explained. Find pricing, specs, and where to buy.',
  openGraph: {
    title: 'Gpu Shortage Explained | GPU Drip',
    description: 'Comprehensive guide and analysis for Gpu Shortage Explained. Find pricing, specs, and where to buy.',
    type: 'article',
...
const articleSchema = {
    ...
    "headline": "Gpu Shortage Explained | GPU Drip",
    "description": "Comprehensive guide and analysis for Gpu Shortage Explained. Find pricing, specs, and where to buy.",
    "image": "/og-image.svg",
    "author": {
