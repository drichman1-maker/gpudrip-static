...
export const metadata = {
  title: 'Gpu Lifespan Guide | GPU Drip',
  description: 'Comprehensive guide and analysis for Gpu Lifespan Guide. Find pricing, specs, and where to buy.',
  openGraph: {
    title: 'Gpu Lifespan Guide | GPU Drip',
    description: 'Comprehensive guide and analysis for Gpu Lifespan Guide. Find pricing, specs, and where to buy.',
    type: 'article',
...
const articleSchema = {
    ...
    "headline": "Gpu Lifespan Guide | GPU Drip",
    "description": "Comprehensive guide and analysis for Gpu Lifespan Guide. Find pricing, specs, and where to buy.",
    "image": "/og-image.svg",
    "author": {
